...
begin
  Result := TModelItemMetodosFactory.New.Devolver(Self, FParent);
end;
...
function TModelItem.ValorTotal: Currency;
var
  LItem: TVENDAITENS;
begin
  Result := 0;
  ...
  begin
    LItem  := FIterator.Next.Entidade;
    Result := Result + (LItem.PRECO * LItem.QUANTIDADE);
  end;
end;
